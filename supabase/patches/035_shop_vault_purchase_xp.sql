-- Shop Vault 2.0: add XP gain to atomic purchase function
-- Run with: psql $DATABASE_URL -f supabase/patches/035_shop_vault_purchase_xp.sql
BEGIN;
...
BEGIN
  ...
  INSERT INTO public.shop_vault_profile_progress (profile_id, xp)
  VALUES (auth.uid(), v_xp_gain)
  ON CONFLICT (profile_id) DO UPDATE
    SET xp = public.shop_vault_profile_progress.xp + v_xp_gain,
        updated_at = NOW();
