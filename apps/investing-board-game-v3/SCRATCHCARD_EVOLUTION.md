...
- **Done (latest):** Added scratch reveal overlay polish (layered mask + reveal animation) for the ticket grid.
- **Next step:** Add tier selection UI in `CasinoModal` with ticket previews and odds CTA.
