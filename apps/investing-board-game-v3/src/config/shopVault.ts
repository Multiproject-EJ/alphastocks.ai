...
export const VAULT_PURCHASE_XP_MIN = 25
export const VAULT_PURCHASE_XP_RATE = 0.05
export const VAULT_LEVEL_BASE_XP = 1000
export const VAULT_LEVEL_STEP_XP = 250
