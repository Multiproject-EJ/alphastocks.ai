...
export const SPECIAL_EVENTS: GameEvent[] = [
  ...
  },
  {
    ...
    title: 'Founders Day Rally',
    description: 'Celebrate launch week with bonus stars and XP.',
    type: 'special',
    startDate: new Date('2026-04-15T00:00:00'),
    endDate: new Date('2026-04-18T00:00:00'),
    isActive: false,
    effects: { starsMultiplier: 2, xpMultiplier: 1.5 },
    icon: '🎉',
    currency: createCurrencyRules('🎉', 5, 22, 500),
  },
  {
    id: 'summer-market-festival-2026',
    title: 'Summer Market Festival',
    description: 'Sun-soaked bonuses and a 2x star surge.',
    type: 'special',
    startDate: new Date('2026-07-03T00:00:00'),
    endDate: new Date('2026-07-06T00:00:00'),
    isActive: false,
    effects: { starsMultiplier: 2 },
    icon: '🌞',
    currency: createCurrencyRules('🌞', 5, 24, 520),
  },
  {
    id: 'holiday-rally-2026',
    title: 'Holiday Rally',
    description: 'End-of-year celebration with boosted rewards.',
    type: 'special',
    startDate: new Date('2026-12-24T00:00:00'),
    endDate: new Date('2026-12-27T00:00:00'),
    isActive: false,
    effects: { starsMultiplier: 2.5, xpMultiplier: 2 },
    icon: '🎁',
    currency: createCurrencyRules('🎁', 6, 26, 700),
  },
]
